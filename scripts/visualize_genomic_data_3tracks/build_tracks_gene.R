...
source("scripts/visualize_genomic_data_3tracks/utils_gviz/gviz_loadRanges.R")
...
#
source("scripts/visualize_genomic_data_3tracks/utils_gviz/gviz_visualize_tracks.R")
...
for (i in 1:nrow(df)) {
  ...
  #
  source("scripts/visualize_genomic_data_3tracks/utils_gviz/gviz_set_params.R")
  
  #
  source("scripts/visualize_genomic_data_3tracks/utils_gviz/gviz_readBigwig.R")
  
  #
  output_dir <- "output/analysis/tracks_plotgardener_3tracks"
  ...
  #
  source("scripts/visualize_genomic_data_3tracks/utils_gviz/gviz_plotSignal.R")
  
  #
  source("scripts/visualize_genomic_data_3tracks/utils_gviz/gviz_plotGenes.R")
  
  #
  source("scripts/visualize_genomic_data_3tracks/utils_gviz/gviz_plotRanges.R")
